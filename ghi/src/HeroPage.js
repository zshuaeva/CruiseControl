            ...
            <div className="row mt-5">
                <div className="col-md-6">
                    ...
                    <p className="lead">
                        ...
                        cutting-edge software solution designed specifically for the
                        vehicle service industry.
                    </p>
                    <p>
                        Empower your business to grow by automating tedious tasks, streamlining
                        workflows, and enhancing customer satisfaction.
                    </p>
                    <Link className="btn btn-primary btn-lg" to="clientsignup" role="button">
            ...
            <div className="row mt-5">
                <div className="col-md-12">
                    ...
                    <ul>
                        ...
                        <li>Efficient technician management with complete service history</li>
                        <li>Easy service creation, customization, and checklist handling</li>
