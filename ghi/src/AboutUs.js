        ...
        <Col>
          <Card>
            ...
            <Card.Body>
              ...
              <Button variant="primary" href="https://www.linkedin.com/in/joshuaevangelista/">
                LinkedIn
              </Button>
            </Card.Body>
          </Card>
...
I got out of bed at all"
              ...
              <Button variant="primary" href="https://www.linkedin.com/in/lee-aaron-s">
                LinkedIn
              </Button>
            </Card.Body>
          </Card>
        ...
        <Col>
          <Card>
            ...
            <Card.Body>
              ...
              <Button variant="primary" href="https://www.linkedin.com/in/nicholas-s-trevino/">
                LinkedIn
              </Button>
            </Card.Body>
          </Card>
        ...
        <Col>
          <Card>
            ...
            <Card.Body>
              ...
              <Button variant="primary" href="https://gitlab.com/kennethwilson0619">
                GitLab
              </Button>{" "}
              <Button variant="primary" href="www.linkedin.com/in/kennethwilson0619">
                LinkedIn
              </Button>
            </Card.Body>
          </Card>
